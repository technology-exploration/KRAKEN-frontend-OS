...
import Badge, { DataUnionBadge, IconBadge, AnalyticsProductBadge, BatchProductBadge } from './Badge'
...
const ImageTile = ({
    ...
    <Tile {...props} suppressHover>
        <Tile.ImageContainer autoSize height={height}>
            ...
            {!!showAnalyticsBadge && (
                <AnalyticsProductBadge top left />
            )}
            {!!showBatchBadge && (
                <BatchProductBadge top left />
            )}
        </Tile.ImageContainer>
    </Tile>
)
...
const MarketplaceProductTile = ({
    product, showDataUnionBadge, showAnalyticsBadge, showBatchBadge, ...props
    ...
    <Tile {...props}>
        ...
        >
            <Summary
                name={product.name}
                description={product.owner}
                label={(isPaidProduct(product) && product.type !== 'ANALYTICS') ? (
                    <PaymentRate
