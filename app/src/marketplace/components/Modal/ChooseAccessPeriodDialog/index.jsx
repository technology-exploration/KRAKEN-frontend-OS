...
import { dataToEur, formatDecimals, dataForTimeUnits } from '$mp/utils/price'
...
export const ChooseAccessPeriodDialog = ({
    ...
    const [approxEur, setApproxEur] = useState('-')
    ...
    const displayApproxEur = useMemo(() => (
        BN(approxEur).isNaN() ? 'N/A' : formatDecimals(approxEur, contractCurrencies.EUR)
    ), [approxEur])
                ...
                <div className={styles.root}>
                    ...
                    <div className={styles.balanceAndPrice}>
                        ...
                        <span className={styles.usdEquiv}>
                            {I18n.t('modal.chooseAccessPeriod.approx')} {displayApproxEur} {contractCurrencies.EUR}
                        </span>
                    </div>
