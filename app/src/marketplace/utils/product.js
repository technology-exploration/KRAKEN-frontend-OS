...
export const isPaidProduct = (product: Product) => product.isFree === false || BN(product.pricePerSecond).isGreaterThan(0) || product.type === 'ANALYTICS'
...
export const isDataUnionProduct = (productOrProductType?: Product | ProductType) => {
    ...
    return type === productTypes.STREAMS
}
