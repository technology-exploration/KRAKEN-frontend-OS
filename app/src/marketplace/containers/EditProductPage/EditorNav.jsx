...
const EditorNav = () => {
    ...
    const sections = useMemo(() => {
        ...
        // }, {
        //     id: 'shortDescription',
        //     heading: I18n.t('editProductPage.navigation.shortDescription'),
        //     status: getStatus('shortDescription'),
        }, {
            id: 'description',
            ...
            id: 'policies',
            heading: I18n.t('editProductPage.navigation.policies'),
            status: getStatus('policies'),
        },
        ...
        ...includeIf(!isDataUnion, [{
            id: 'processDataset',
            heading: I18n.t('editProductPage.navigation.productDataset'),
            status: getStatus('keyShares'),
        }]),
        ...includeIf(product.type !== 'ANALYTICS', [{
            id: 'price',
            heading: I18n.t('editProductPage.navigation.price'),
            status: priceStatus,
        }]),
        ...includeIf(product.type === 'BATCH' && currentUser.institutionalAffiliation === 'No', [{
            id: 'privacyMetricsTool',
            heading: 'Privacy metrics',
            status: getStatus('privacyMetrics'),
        }]),
        ]
