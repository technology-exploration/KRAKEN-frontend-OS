...
import { Paper, Button, Select, MenuItem, InputLabel, FormControl } from '@material-ui/core'
...
const Container = styled.section`
    margin: 0 50px
`
const AdversaryStrength = () => {
    const classes = useStyles()
    const paperStyle = {
        padding: '50px 50px', width: 600, margin: '20px auto',
    }
    ...
    const handleClickAdversary = (e) => {
        e.preventDefault()
        const state = {
            advStrength, advStrength1, advStrength2, advStrength3, advStrength4, advStrength5, q1, q2, q3, q4,
        }
