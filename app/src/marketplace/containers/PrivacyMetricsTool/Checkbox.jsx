...
export default function CheckboxLabels(adversaryState) {
    ...
    const history = useHistory() // needed for flow between the pages

    // sends data to the backend
    const handleClick = (e) => {
        e.preventDefault()
        const input = {
            ...state, ...adversaryState.adversaryState,
        } // no idea why this needs adversaryState.adversaryState, but it works
