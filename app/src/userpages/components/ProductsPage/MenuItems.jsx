...
export const ManageSubscriptions = ({ id }: any) => (
    <MenuItem
        tag={MenuLink}
        to={routes.marketplace.manageSubscriptions({
            id,
        })}
    >
        <Translate value="Manage subscribers" />
    </MenuItem>
)

export const Delete = ({ onClick }: any) => (
    <MenuItem
        // disabled={disabled}
        onClick={onClick}
    >
        <Translate value="Delete product" />
    </MenuItem>
)
